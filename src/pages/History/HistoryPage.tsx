            ...
            <div className={styles.container}>
                ...
                {files.map((file, index) => (
                    <div key={index} className={styles.row}>
                        <div className={styles.rowContent} onClick={() => {
                            const fileData = file.processed ? [
                                {
                                    value: file.total_spend_galactic !== undefined ? String(file.total_spend_galactic) : "",
                                ...
                                {value: file.big_spent_civ ?? "", description: "цивилизация с максимальными расходами"},
                                {value: file.less_spent_civ ?? "", description: "цивилизация с минимальными расходами"},
                                {
                                    value: file.big_spent_at !== undefined ? String(file.big_spent_at) : "",
                                    description: "день года с максимальными расходами"
                                },
                                {
                                    value: file.big_spent_value !== undefined ? String(file.big_spent_value) : "",
                                    description: "максимальная сумма расходов за день"
                                },
                                {
                                    value: file.average_spend_galactic !== undefined ? String(file.average_spend_galactic) : "",
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                {selectedHighlights ? (
                    ...
                    <div className={styles.notHighlights}>
                        Хайлайты недоступны для этого файла
                    </div>
                )}
            </Modal>
        </>
